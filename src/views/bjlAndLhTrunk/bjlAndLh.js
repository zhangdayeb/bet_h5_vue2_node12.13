...
export default {
	...
	data(){
		return {
            ...
            betTargetListBjl: [{
                id: 2,
                label: this.$t("bjlAndLh.playerPair"),
                value: 'idle-Pair',
                className: 'bet-idle-Pair',
                color:'white',
                imgUrl: require('@/assets/imgs/bet/xian_pair.png'),
                textShadow: '0 0 blue',
                odds: '',
                betAmount: 0,
                showChip: [],
            ...
            }, 
            {
                ...
                value: 'lucky',
                className: 'bet-lucky',
                imgUrl: require('@/assets/imgs/bet/lucky.png'),
                color:'white',
                textShadow: '0 0 blue',
                odds: '',
                imgWidth: 55,
            ...
            }, 
            {
                ...
                color:'white',
                textShadow: '0 0 blue',
                imgUrl: require('@/assets/imgs/bet/zhuang_pair.png'),
                odds: '',
                betAmount: 0,
                showChip: [],
                imgWidth: 47,
            ...
            }, 
            {
                ...
                odds: '',
                betAmount: 0,
                imgUrl: require('@/assets/imgs/bet/xian.png'),
                showChip: [],
                imgWidth: 30,
                total_amount: 0,
                total_population: 0,
            }, 
            {
                ...
                color:'',
                odds: '',
                imgUrl: require('@/assets/imgs/bet/he.png'),
                betAmount: 0,
                showChip: [],
                imgWidth: 30,
                total_amount: 0,
            ...
            }, 
            {
                ...
                color:'',
                imgUrl: require('@/assets/imgs/bet/zhuang.png'),
                odds: '',
                betAmount: 0,
                showChip: [],
                imgWidth:30,
            ...
            betTargetListLongHu: [
				{
				    ...
				    className: 'bet-idle',
					color:'',
					imgUrl: require('@/assets/imgs/bet/dragon.png'),
				    odds: '',
				    betAmount: 0,
				    showChip: [],
                    imgWidth: 40,
				...
				},
				{
					...
					color:'',
                    odds: '',
					imgUrl: require('@/assets/imgs/bet/lh_he.png'),
                    betAmount: 0,
                    showChip: [],
                    imgWidth: 40,
                    total_amount: 0,
                ...
                },
				{
				    ...
				    odds: '',
				    betAmount: 0,
					imgUrl: require('@/assets/imgs/bet/tigger.png'),
				    showChip: [],
                    imgWidth: 40,
				    total_amount: 0,
				    total_population: 0,
            ...
            if(this.bureauNumber != bureau_number) {
				...
				setTimeout(() => {
                    if(this.gameType == 3) {
                        ...
                        this.audioHandle.startSoundEffect(`tiger${this.resultInfo.result.tigger}.wav`)
                    }
				},time)
				setTimeout(() => {
                    if(this.gameType == 3) {
                        ...
                        this.audioHandle.startSoundEffect(`dragon${this.resultInfo.result.dragon}.wav`)
                    }
				},time + 2500)
				setTimeout((win=0) => {
					//主结果 =1 庄赢  =2 闲赢 =3 和牌 
