...
export default {
	...
	data(){
		return {
            ...
            //     className: 'bet-zhuang',
            //     color:'',
            //     imgUrl: require(`@/assets/imgs/bet/${this.$VueI18n.global.locale}/big-tiger.png`),
            //     odds: '',
            //     betAmount: 0,
            //     showChip: [],
            //     imgWidth:30,
            ...
            //     className: 'bet-zhuang',
            //     color:'',
            //     imgUrl: require(`@/assets/imgs/bet/${this.$VueI18n.global.locale}/small-tiger.png`),
            //     odds: '',
            //     betAmount: 0,
            //     showChip: [],
            //     imgWidth:30,
    ...
    //                 }
        ...
        */
        ...
        betOrder() {
            ...
            // 免佣状态 获取
            let is_exempt = this.Freebool ? 1 : 0;
            let data = {
        ...
        */
        getBetCurrentRecord() {
            ...
            bjlService.getBetCurrentRecord({id: this.tableId, 'game_type': this.gameType,}).then(res => {
                ...
                this.Freebool = res.is_exempt == 0 ? true : false
        ...
        */
        bet(target){
            ...
            this.betTargetList.forEach((item,index) => {
                ...
                // 客户要求 暂时注释
                // if(item.className == 'bet-lucky' && !this.Freebool == true){
                //     return
                // }
